...
<div class="main-content-area">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
        <div>
            ...
            <p class="text-sm sm:text-base text-gray-600 mt-1">
                แก้ไขการตั้งค่า: <span class="font-medium">{{ $setting->key }}</span>
            </p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('backend.settings.update', $setting) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-md p-4">
                        ...
                        <div class="text-sm text-gray-700">
                            <div class="mb-2">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $setting->type_color }} ml-2">
                            ...
                            <div class="mb-2">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $setting->group_color }} ml-2">
                                    {{ ucfirst($setting->group) }}
                                </span>
                            </div>
                            <div>
                                <span class="font-medium">ค่า:</span>
                                <span class="ml-2 font-mono text-xs bg-white px-2 py-1 rounded border">
