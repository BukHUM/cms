...
@section('page-title', 'เพิ่มบทบาท')
@section('page-description', 'สร้างบทบาทใหม่ในระบบ')
...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('backend.roles.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="กรอกคำอธิบายบทบาท">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
